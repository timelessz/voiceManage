<?php if (!defined('THINK_PATH')) exit();?><div class="easyui-layout layout_userlist">
    <div data-options="region:'west',split:true" title="订单分类" style="width:150px;">
        <ul class="easyui-tree tree_userlist" data-options="url:'/voiceManage/index.php/Admin/Alllist/jsonTree'" style="padding: 10px 5px;">
        </ul>
    </div>
            ...
            $(function() {
                ...
                $('.tree_' + classId).tree({
                    onClick: function() {
                        ...
                        var url = '/voiceManage/index.php/Admin/Alllist/userList?id=' + id;
